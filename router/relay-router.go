...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.MaintenanceCheck(), middleware.ConcurrencyLimit(), middleware.Distribute())
	{
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.MaintenanceCheck(), middleware.ConcurrencyLimit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.ConcurrencyLimit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.MaintenanceCheck(), middleware.ConcurrencyLimit(), middleware.Distribute())
	{
